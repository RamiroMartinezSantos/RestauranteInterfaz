...
public class MostrarBebidas extends JFrame{
    private JTable jTable;
    private JPanel panelContainer, panelButton;
    private JButton btnQuery;
    private DefaultTableModel modelo;

    public MostrarBebidas (){
        initControl();
        configTable();
        setControl();
        configPanel();
    ...
    private void initControl(){
        ...
        modelo.setColumnIdentifiers(Titulos2.bebida);
        String [] fila = new String[modelo.getColumnCount()];
        ArrayList<Bebidas> lista = Menubebidas.getElemento();
